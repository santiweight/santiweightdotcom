...
export default function Header() {
  return (
    <header className="flex items-center gap-4 mb-10">
      <div className="relative w-[60px] h-[60px] flex-shrink-0 rounded-full overflow-hidden bg-gray-200">
        <Image
      ...
      <div>
        ...
        <div className="mt-1 flex items-center gap-2.5">
          <a
            href="https://github.com/santiweight"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            title="GitHub"
            className="text-[#24292f] hover:opacity-70 transition-opacity"
          >
            <svg
          ...
          <a
            ...
            className="text-[#EA4335] hover:opacity-70 transition-opacity"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
